report 50014 "Transfer Order Report"
{
    // version NAVW111.00,NAVNA11.00

    DefaultLayout = RDLC;
    RDLCLayout = './Transfer Order Report.rdlc';
        ...
        dataitem("Transfer Header"; "Transfer Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(ShipToName; ShipToAdd.Name)
                    {

                    }
                    column(ShipToAddress; ShipToAdd.Address)
                    {

                    }
                    column(ShipToCity; ShipToAdd.City)
                    {

                    }
                    column(ShipToState; ShipToAdd.County)
                    {
                        Caption = 'State';
                    }
                    column(ZipCode; ShipToAdd."Post Code")
                    {
            ...
            begin
                ...
                if ShipToAdd.Get("Customer ID", "Ship To Code") then;

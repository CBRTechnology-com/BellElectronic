report 50012 "Pick Ticket"
{
    // version CBR_SS

    DefaultLayout = RDLC;
    RDLCLayout = './Pick Ticket.rdlc';
        ...
        dataitem(CopyLoop; "Integer")
        {
            ...
            dataitem("Sales Header"; "Sales Header")
            {
                ...
                dataitem("Sales Line"; "Sales Line")
                {
                    ...
                    column(SerialNo_1; SerialNo[1])
                    {
                    }
                    column(SerialNo_2; SerialNo[2])
                    {
                    }
                    column(SerialNo_3; SerialNo[3])
                    {
                    }
                    column(SerialNo_4; SerialNo[4])
                    {
                    }
                    column(SerialNo_5; SerialNo[5])
                    {
                    }
                    ...
                    begin
                        ...
                        if ReservEntry.FindSet then
                            repeat
                                i += 1;
                                SerialNo[i] := ReservEntry."Serial No.";

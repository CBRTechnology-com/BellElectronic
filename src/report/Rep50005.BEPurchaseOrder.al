report 50005 "BE Purchase Order"
{
    // version NAVNA10.00

    DefaultLayout = RDLC;
    RDLCLayout = './BE Purchase Order.rdlc';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompanyInformationTaxExemptionNo; CompanyInformation."Tax Exemption No.")
                    {
                    }
                    ...
                    column(CompanyShippingAccount; CompanyInformation."Shipping Account")
                    {
                    }
                    column(VendTaxRegNo; Vend."VAT Registration No.")
                    {
                    }
                    column(VendFederalIDNo; Vend."Federal ID No.")
                    {
                    }
                    column(Memo; "Purchase Header".Memo)
                    {
                    }
                    column(ShippingAgent; "Purchase Header"."Shipping Agent Code")
                    {
                    }
                    column(ShippingAgentService; "Purchase Header"."Shipping Agent Service Code")
                    {
                    }
                    ...
                    column(ShipperAccNo; "Purchase Header"."Shipper Acct No.")
                    {

                    }
                    column(ShipperAccDescription; "Purchase Header"."Shipper Acct Desc")
                    {

                    }
                    column(ExptDate; "Purchase Header"."Expected Receipt Date")
                    {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(Type_Line; "Purchase Line".Type)
                        {
                        }
            ...
            begin
                if PrintCompany then
                    ...
                    END;
                //CurrReport.Language := LanguageCU.GetLanguageID("Language Code"); //CBR_SS

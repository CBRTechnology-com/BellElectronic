report 50003 "BE Sales Order"
{
    // version NAVNA10.00,BELL005

    DefaultLayout = RDLC;
    RDLCLayout = './BE Sales Order.rdlc';
    Caption = 'Sales Order';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(Shipper_Acct_No_; "Shipper Acct No.")
            {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoContactNo; "Sales Header"."Bill-to Contact")
                    {
                    }
                    ...
                    column(ShippingAgentService; "Sales Header"."Shipping Agent Service Code")
                    {
                    }
                    column(PaymentAccount; "Sales Header"."Payment Account")
                    {
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(Type_Line; Format(TempSalesLine.Type))
                        {
                        }
    ...
    begin
        // Bell >>
        // SalesLineReserve.FilterReservFor(ReservationEntry, TempSalesLine);
        ...
        ReservationEntry.SetRange("Location Code", TempSalesLine."Location Code");
